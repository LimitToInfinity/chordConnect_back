...
ActiveRecord::Schema.define(version: 2019_07_30_012502) do
  ...
  create_table "artist_agents", force: :cascade do |t|
    t.bigint "artist_id"
    t.bigint "agent_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["agent_id"], name: "index_artist_agents_on_agent_id"
    t.index ["artist_id"], name: "index_artist_agents_on_artist_id"
  end
  ...
  add_foreign_key "artist_agents", "agents"
  add_foreign_key "artist_agents", "artists"
